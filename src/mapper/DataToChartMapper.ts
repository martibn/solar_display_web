...
export default class DataToChartMapper{
    ...
    static arrToTodayData(model: SolarData[], periodicity: string) : TodayData{
        ...
        model.forEach(element => {
          ...
          vals.datasets[2].data.push(periodicity === "hour" ? element.grid_consumption : -Math.abs(element.grid_consumption));
